...
class OpenAICliAdapter(CliAdapterBase):
    ...
    async def fetch_models(
        ...
        # 复用 OpenAIChatAdapter 的实现，叠加 CLI User-Agent（不破坏 headers 规则格式）
        ...
        models, error = await OpenAIChatAdapter.fetch_models(client, base_url, api_key, combined_headers)
